...
echo "***********************************"
docker exec quanta-dev2 /bin/sh -c "curl -i -H 'Accept: application/activity+json' 'http://q1:8184/ap/u/bob'"
echo
echo
...
# echo "***********************************"
# docker exec quanta-dev2 /bin/sh -c "curl -i -H 'Accept: application/activity+json' 'http://q1:8184/ap/u/adam'"
# echo
# echo
