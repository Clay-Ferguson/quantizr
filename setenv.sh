...
# Should point to a script that exports these variables: ${subnodeAESKey} and ${subnodePassword}
export SECRET_SCRIPT=../meta64Oak-private/secrets.sh

# Path where the log files generated by the running app get stored.
export SUBNODE_LOG_FOLDER=/home/clay/ferguson/subnode-log

# Path where the log files generated by the running app get stored.
export SUBNODE_LUCENE_FOLDER=/home/clay/ferguson/subnode-lucene

# Path that Quantizr app will use at runtime as it's temp folder
export SUBNODE_TMP_FOLDER=/home/clay/ferguson/subnode-tmp
