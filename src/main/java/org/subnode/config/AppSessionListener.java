...
public class AppSessionListener implements HttpSessionListener {
	...
	public void sessionCreated(HttpSessionEvent se) {
		...
		// just synchronize on it using synchronize keyword and treating it just
		// as a plain Object would be used for a lock, but for our own API use of this
		// lock we call lockEx() and unlockEx() on this object to use its'
		// built in ability to detect and forcably break deadlocks when they happen!
