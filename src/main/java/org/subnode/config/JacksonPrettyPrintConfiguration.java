...
/**
 * Supposedly this property (below) can also turn on pretty printing, but i never tried
 * that, because i know I want the most powerful way of controlling formatting
 * in case i need to do more advanced formatting at some point in the future.
