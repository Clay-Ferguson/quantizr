 ...
 * 
 * todo-0: I think the best to fix the thread problem is to ONLY instantiate this bean INSIDE a rest
 * call method (basically AppController.java only) and set it in a threalocal there somehow. Do this incrementally
 * and carefully or you would wreak haveoc and have problems hard to find.
 */
@Component
