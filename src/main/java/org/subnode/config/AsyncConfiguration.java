...
/**
 * This class is commented out because the application.property as follows
 * appears to be enough, to make video streaming not timeout after a minute or
 * so, which is all I was trying to accomplish, so the code in thie file
