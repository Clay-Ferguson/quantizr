...
export class AnthAiAnswerType extends TypeBase {
    constructor() {
        super(J.NodeType.ANTHAI_ANSWER, "AI Answer (Anthropic AI)", "fa-android", false);
    }
    ...
    override getCustomFooter(node: NodeInfo): Div {
        return S.aiUtil.getAiNodeFooter("by Anthropic AI", node);
    }
