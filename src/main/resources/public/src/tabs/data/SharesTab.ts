...
export class SharesTab extends TabBase<SharesRSInfo, SharedNodesResultSetView<SharesRSInfo>> {
    ...
    constructView = (data: TabBase<SharesRSInfo, SharedNodesResultSetView<SharesRSInfo>>) => new SharedNodesResultSetView<SharesRSInfo>(data);
