    ...
    renderDlg(): CompIntf[] {
        let children = [
            new Form(null, [
                ...
                new TextField("User Name", null, false, null, new CompValueHolder<string>(this, "user")),
                new TextField("Email Address", null, false, null, new CompValueHolder<string>(this, "email")),
                new ButtonBar([
