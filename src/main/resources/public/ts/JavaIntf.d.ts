...
export const enum NodeProp {
    ENC_KEY = "ENC_KEY",
    RSS_FEED_SRC = "RSS_FEED_SRC",
    USER_PREF_PUBLIC_KEY = "USER_PREF_PUBLIC_KEY",
    USER_PREF_EDIT_MODE = "USER_PREF_EDIT_MODE",
    USER_PREF_SHOW_METADATA = "USER_PREF_SHOW_METADATA",
    USER_PREF_IMPORT_ALLOWED = "USER_PREF_IMPORT_ALLOWED",
    USER_PREF_EXPORT_ALLOWED = "USER_PREF_EXPORT_ALLOWED",
    USER_PREF_PASSWORD_RESET_AUTHCODE = "USER_PREF_PASSWORD_RESET_AUTHCODE",
    SIGNUP_PENDING = "SIGNUP_PENDING",
    EMAIL_CONTENT = "EMAIL_CONTENT",
    EMAIL_RECIP = "EMAIL_RECIP",
    EMAIL_SUBJECT = "EMAIL_SUBJECT",
    TARGET_ID = "TARGET_ID",
    USER = "USER",
    PWD_HASH = "PWD_HASH",
    FILE_SYNC_LINK = "FILE_SYNC_LINK",
    FILENAME = "FILENAME",
    NAME = "NAME",
    IPFS_LINK = "IPFS_LINK",
    IPFS_LINK_NAME = "IPFS_LINK_NAME",
    FS_LINK = "FS_LINK",
    IPFS_OK = "IPFS_OK",
    MIME_EXT = "MIME_EXT",
    EMAIL = "EMAIL",
    ...
    BIN_SIZE = "BIN_SIZE",
    FILE_NAME = "FILE_NAME",
    JSON_FILE_SEARCH_RESULT = "JSON_FILE_SEARCH_RESULT",
    PRE = "PRE",
    NOWRAP = "NOWRAP",
    BIN_DATA = "BIN_DATA",
    BIN = "BIN",
